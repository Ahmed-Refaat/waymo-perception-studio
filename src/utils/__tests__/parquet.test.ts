/**
 * Integration tests for parquet.ts — reads mock Waymo v2.0 Parquet fixtures.
 *
 * Fixtures are generated by scripts/generate_fixtures.py and live in
 * src/__fixtures__/mock_segment_0000/.
 */

import { describe, it, expect, beforeAll } from 'vitest'
import { openSync, readSync, fstatSync, readFileSync } from 'fs'
...
describe('Small files — full load', () => {
  ...
  it('reads lidar_box: >10K rows with tracking IDs', async () => {
...
// ---------------------------------------------------------------------------
// Tests: merge() with fixture data
// ---------------------------------------------------------------------------

describe('merge() with fixture data', () => {
  ...
  it('groupIndexBy groups boxes by frame timestamp', async () => {
    ...
    // Check average objects per frame is reasonable (~75)
